...
def jogar():
    ...
    botao_choicex_2 = Button(frame2, command=lambda: clica(botao_choicex_2), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_2.place(x=230, y=50)

    botao_choicex_3 = Button(frame2, command=lambda: clica(botao_choicex_3), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_3.place(x=290, y=50)

    botao_choicex_4 = Button(frame2, command=lambda: clica(botao_choicex_4), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_4.place(x=170, y=108)

    botao_choicex_5 = Button(frame2, command=lambda: clica(botao_choicex_5), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_5.place(x=230, y=108)

    botao_choicex_6 = Button(frame2, command=lambda: clica(botao_choicex_6), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_6.place(x=290, y=108)

    botao_choicex_7 = Button(frame2, command=lambda: clica(botao_choicex_7), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_7.place(x=170, y=168)

    botao_choicex_8 = Button(frame2, command=lambda: clica(botao_choicex_8), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
    botao_choicex_8.place(x=227, y=168)

    botao_choicex_9 = Button(frame2, command=lambda: clica(botao_choicex_9), width=3, height=1, text= '', anchor=CENTER, font='Arial 16 bold', bg=cinza2, fg=preto, relief=FLAT)
        ...
        if jogada < 10:
            if jogada in impar:
                ...
                if botao_choicex_1['text'] == 'X' and botao_choicex_2['text'] == 'X' and botao_choicex_3['text'] == 'X':
                    vencedor = Label(frame2, text='X Venceu!', font='Arial 18 bold', bg=cinza2, fg=preto)
